...
export class TutorialComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.descriptions = [
      'To have a better overview over the current game, you can move yourself arround by dragging the map or zoom in-out with your mouse wheel. Collapsing and expanding certain areas of your viewport will provide you with a cleaner and more focused screen.',
      'To make a move with one of your playing pieces, select all the cards you want to us for your move by clicking them. Then, select one of your playing pieces - you are now shown all the possible positions you can move to. By clicking on one of the highlighted fields, your playing piece will move to the new position.',
      ...
      'There are a few cards in the game that allow for special moving. With selecting the card and a playing piece, the pathfinder will show you all reachable fields automatically, supporting you in executing the move.',
      ...
      'When the first player has all its playing pieces moved to ElDorado, the round will be played to an end before a winner is determined. The player that started the game is indicated via the hut symbol. If no player wears the hut, you started the game yourself. The order of play is from top to bottom.',
